...
/* Code Written by: José Eduardo da Silva Vieira, as a Bachelor's degree final project.
   You can find it on my git as well: https://github.com/Jose-Vieira/goGrow_Blynk
   Fell free to use it as you want. But just remember, if you do use it. keep the author name on it.
   */
